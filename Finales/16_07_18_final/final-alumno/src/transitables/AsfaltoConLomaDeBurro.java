...
public class AsfaltoConLomaDeBurro implements Transitable {

    private static final int VELOCIDAD_MOTO = 20;
    private static final int VELOCIDAD_AUTO = 20;
    private static final int VELOCIDAD_AUTO_CUATRO_POR_CUATRO = 20;
